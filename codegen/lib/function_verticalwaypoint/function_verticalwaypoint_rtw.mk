...
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/function_verticalwaypoint.a
...
PRODUCT_NAME              = function_verticalwaypoint
MAKEFILE                  = function_verticalwaypoint_rtw.mk
COMPUTER                  = GLNXA64
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/function_verticalwaypoint.a
...
INCLUDES_BUILDINFO = -I$(START_DIR)/codegen/lib/function_verticalwaypoint -I$(START_DIR) -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert
...
DEFINES_STANDARD = -DMODEL=function_verticalwaypoint -DHAVESTDIO -DUSE_RTMODEL -DUNIX
...
%.o : $(START_DIR)/codegen/lib/function_verticalwaypoint/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/codegen/lib/function_verticalwaypoint/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
