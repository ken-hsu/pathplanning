/*
 * File: _coder_calculate_distance2_api.c
 *
...
emlrtContext emlrtContextGlobal = { true,/* bFirstTime */
  ...
  NULL,                                /* fErrorFunction */
  "calculate_distance2",               /* fFunctionName */
  NULL,                                /* fRTCallStack */
  false,                               /* bDebugMode */
...
static void emlrt_marshallIn(const emlrtStack *sp, const mxArray *waypoint_lat,
  ...
  const char_T *identifier, real_T **y_data, int32_T y_size[1])
{
  ...
  thisId.fParent = NULL;
  thisId.bParentIsCell = false;
  b_emlrt_marshallIn(sp, emlrtAlias(waypoint_lat), &thisId, &r0, y_size);
  *y_data = r0;
  emlrtDestroyArray(&waypoint_lat);
}
 ...
 * Return Type  : void
 */
void calculate_distance2_api(const mxArray * const prhs[4], const mxArray *plhs
  [2])
{
  emxArray_real_T *x_coordination;
  emxArray_real_T *dis_meter;
  real_T (*waypoint_lat_data)[2000];
  int32_T waypoint_lat_size[1];
  real_T (*waypoint_lon_data)[2000];
  int32_T waypoint_lon_size[1];
  real_T num_point;
  real_T InitLat;
  ...
  emlrt_marshallIn(&st, emlrtAlias((const mxArray *)prhs[0]), "waypoint_lat",
                   (real_T **)&waypoint_lat_data, waypoint_lat_size);
  emlrt_marshallIn(&st, emlrtAlias((const mxArray *)prhs[1]), "waypoint_lon",
                   (real_T **)&waypoint_lon_data, waypoint_lon_size);
  num_point = c_emlrt_marshallIn(&st, emlrtAliasP((const mxArray *)prhs[2]),
    "num_point");
  InitLat = c_emlrt_marshallIn(&st, emlrtAliasP((const mxArray *)prhs[3]),
    "InitLat");

  /* Invoke the target function */
  calculate_distance2(*waypoint_lat_data, waypoint_lat_size, *waypoint_lon_data,
                      waypoint_lon_size, num_point, InitLat, x_coordination,
                      dis_meter);
 ...
 * Return Type  : void
 */
void calculate_distance2_atexit(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
  ...
  calculate_distance2_xil_terminate();
}
 ...
 * Return Type  : void
 */
void calculate_distance2_initialize(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
 ...
 * Return Type  : void
 */
void calculate_distance2_terminate(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
...
/*
 * File trailer for _coder_calculate_distance2_api.c
 *
 * [EOF]
 */
